...
/* 
    ...
    -> div 와 같은 태그로 최상위(부모박스)를 만들어서 내보내기를 해야한다
    -> 그런데 이런 불필요한 태그 구조를 원치 않는 경우
      <React.Fragment> </React.Fragment> 를 사용하면
      내보낼때 하나로 묶는 역할만하고 실제로 태그는 출력안됨!
...
function MyFirstReact() {
  ...
  return (
    <React.Fragment>
      <h1>나는 리엑트가 개좋다!!!! ㅎㅎㅎㅎ</h1>
      <img class="aaaa" src="https://cdn.icon-icons.com/icons2/2415/PNG/512/react_original_wordmark_logo_icon_146375.png" alt="라이츄 1000만볼트" />
      <h2>
        [ 리엑트란 무엇인가? ]
        <br />
        ...
        <iframe width="1280" height="720" src="https://www.youtube.com/embed/05uFo_-SGXU?list=PLZKTXPmaJk8J_fHAzPLH8CJ_HO_M33e7-" title="React JS #1 강의 소개 - 초보자를 위한 리액트 강좌" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

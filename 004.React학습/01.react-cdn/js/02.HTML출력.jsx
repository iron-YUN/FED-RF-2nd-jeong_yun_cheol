...
// JSX 태그 중간에 변수나 수식을 출력할떄는 중괄호만 사용함
// <태그>{변수/표현식}</태그>
...
// 코드를 작성한다!
// map()메서드를 사용한다! 그런데 과연 이함수는 JS 순수함수인가?
// 아니다!! 리엑트의 map()메서드는 리엑트전용이다!
// 그래서 html태그를 화면에 출력할때 JS 에서 했던
// join('')메서드 사용을 하지 않아도 태그가 그대로 클릭하게 출력됨!

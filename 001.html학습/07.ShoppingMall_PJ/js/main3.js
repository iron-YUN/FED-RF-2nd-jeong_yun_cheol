...
function loadFn() {
  ...
  function goSlide() {
    ...
    // console.log('오른쪽버튼임?',isRbtn,this);

    // 2.버튼에따른 전역슬라이드 번호 증감하기
    // (1)오른쪽버튼일 경우 증가
    // -> 한계설정 : snum이 개수-1와 같으면 첫번호 0

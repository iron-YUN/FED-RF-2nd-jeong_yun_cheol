...
function  changeSlide (){
    ...
    //classList.contains(클래스명)-> 해당클래스명이면 true
    console.log("나야",isR);
    ...
    // 3-1. 오른쪽버튼일 경우
    if(isR){
        // 오른쪽에서 이미지박스가 들어오므로 맨앞div 맨뒤로 이동함!
        // appendChild(맨앞div)
        // 대상 : gbx
    ...
    // 3-1. 왼쪽버튼일 경우
        ...
        // 왼쪽에서 이미지박스가 들어오므로 맨뒤div 맨앞로 이동함!
...
// 오른쪽 이동함수 ////
const goTight = () => gbx.appendChild(mFn.qsaEl(gbx,"div")[0]);
...
// 인터발 호출함수 ///
const autoSlide = () => autoI = setInterval(goTight, 3000);
// 인터발함수 최초호출 /////
autoSlide();

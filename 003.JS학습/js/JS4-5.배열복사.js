...
console.log('원본 gg:',gg);

// 배열의 깉은 복사인 스프레드 연산자를 사용해서 할당
// let hh = [...gg]; -> 효과없음

// 깊은복사방법은 기존 객체배열값을 문자화하고 다시 객체화한다!
// -> JSON.parse(JSON.stringify(배열값))
//parse() 메서드는 구문을 분석하여 원래구문 형식으로 변환해주는 열학하는 메서드임
...
hh = JSON.parse(JSON.stringify(gg));
hh[0]["송"] = 888;
console.log('hh변경후 값 :  \n gg:',gg,'\n hh:',hh);
...
let autoI;
function goR1(){
    // 호출이 한번만 되도록 autoI 가 할당전엔 undefined
    // 이므로 if문에서 false처리됨! 이것을 이용하자!
...
/**************************************************
 ...
 (1) Math.random() * 원하는 최대수
    ...
    예) 4~12 는  Math.ceil(Math.random() * 9)+3
**************************************************/

...
// [import 방법1 : 보내준이름 그대로 쓰기]
// import { mTitle, sTitle, personInfo, mvData } from "./text_data.js";

// [import 방법2 : 별칭지어서 쓰기]
//  -> 별칭을 지었으면 반드시 별칭으로 사용해야함!
// import { mTitle as mTit, sTitle as sTit, personInfo as pInfo, mvData as mdt, mTitle } from "./text_data.js";
...
/*************************************************** 
    ...
    1. import문법을 쓰려면 호출하는 html script 요소에
...
// 메시지함수를 호출해서 메시지를 찍어준다!
// txtData.personInfo.forEach(v=>contBox.innerHTML += makeMsg(v[0],v[1]));

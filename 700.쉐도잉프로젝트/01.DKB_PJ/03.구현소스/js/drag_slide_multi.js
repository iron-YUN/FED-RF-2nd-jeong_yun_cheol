...
function slideFn(selEl) {
  ...
  // parentElement 는 선택요소의 직계붐코요소를 선택한다!
  ...
  **********************************/
  function goSlide() {
    ...
    console.log("슬legt", slide.style.left);

      ...
      <table className="dtbl btngrp">
        <tbody>
          <tr>
            <td>
              {
                // 1.글쓰기버튼은 로그인상태이고 "L"이면 출력
                mode == "L" && <button onClick={clickBotton}>Write</button>
              }
              {
                // 2.글보기 "R"상태일경우
                mode == "R" && <button onClick={clickBotton}>List</button>
              }
            </td>
          </tr>
        </tbody>
